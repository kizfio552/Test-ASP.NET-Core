...
namespace Laptop.Controllers
{
    public class CatagoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CatagoryId,CatagoryName,CatagoryImage")] Catagory catagory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CatagoryId,CatagoryName,CatagoryImage")] Catagory catagory)
        {
            if (ModelState.IsValid)
            {
